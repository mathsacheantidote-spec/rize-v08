...
export const JOB_ROLES: JobRole[] = [
  ...
  { id: "cyber", title: "Cybersecurity Analyst", emoji: "", domain: "Security", salary: "₹7–18 LPA", keywords: ["Networks", "Linux", "SIEM", "Pen Testing", "Cryptography"] },
  { id: "ba", title: "Business Analyst", emoji: "", domain: "Business", salary: "₹6–16 LPA", keywords: ["SQL", "Excel", "Stakeholders", "Process Mapping"] },
  { id: "cloud", title: "Cloud Architect", emoji: "", domain: "Cloud", salary: "₹14–35 LPA", keywords: ["AWS", "Docker", "K8s", "Linux", "CI/CD"] },
  { id: "devops", title: "DevOps Engineer", emoji: "", domain: "Cloud", salary: "₹9–22 LPA", keywords: ["Linux", "Docker", "K8s", "CI/CD", "Monitoring"] },
];
